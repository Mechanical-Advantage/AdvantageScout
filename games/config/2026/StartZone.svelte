<script>
  ...
  function isPointInSvg(x, y, ctx) {
    ...
    ctx.lineTo((width / defaultWidth) * 200, (height / defaultHeight) * 40);
    ctx.lineTo((width / defaultWidth) * 200, (height / defaultHeight) * 310);
    ctx.lineTo((width / defaultWidth) * 160, (height / defaultHeight) * 310);
    ctx.lineTo((width / defaultWidth) * 160, (height / defaultHeight) * 40);
    // ctx.lineTo(
