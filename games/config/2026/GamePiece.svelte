  ...
  {:else if location == "Neutral"}
    <svg
      ...
      ><g transform="translate(0,-395)"
        ...
        /><circle cx="40.36" cy="25.5" r="1.12" stroke-linecap="round" /><line
          x1="21.13"
          y1="40.84"
          x2="42.87"
          y2="40.84"
