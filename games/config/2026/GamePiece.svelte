...
>
  ...
  {:else if location == "Neutral"}
    <svg width="800px" height="800px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#91c5cf" fill="none"><g transform="translate(0,-395)"><circle cx="32" cy="32" r="25.74" stroke-linecap="round"/><circle cx="23.62" cy="25.5" r="1.12" stroke-linecap="round"/><circle cx="40.36" cy="25.5" r="1.12" stroke-linecap="round"/><line x1="21.13" y1="40.84" x2="42.87" y2="40.84" stroke-linecap="round"/></g></svg>
  {:else}
