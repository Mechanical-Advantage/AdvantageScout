<script>
    ...
    let autoList = [
    "AutoOuterCellsSuccess",
    "AutoInnerCellsSuccess",
    "AutoBottomCellsSuccess",
    "AutoOuterCellsFail",
    "AutoBottomCellsFail",
    "AutoCellsDrop",
    "AutoFloorCellsCollect",
    "AutoPreloadedCellsCollect",
    "Leave",
    ]

    let tempUndoData = {}

    let teleList = ["TeleOuterCellsSuccess",
    "TeleInnerCellsSuccess",
    "TeleBottomCellsSuccess",
    "TeleOuterCellsFail",
    "TeleInnerCellsFail",
    "TeleBottomCellsFail",
    ...
    "TeleNetAlgaeFail",
    "TeleCellsDrop",
    "TelePreloadedCellsCollect",
    "TeleColorPosFail",
	"TeleColorRotFail",
    "TeleColorPosSuccess",
	"TeleColorRotSuccess",
	"TeleFloorCellsCollect",
    "TeleChuteCellsCollect",
    "TeleCellsDrop",
    "TelePreLoadedCellsCollect",
]
