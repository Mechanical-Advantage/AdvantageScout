<!-- <script>
    ...
    let dockButton = "";
    if ($gameState === 0) {
        dockButton = "AutoHanging";
    } else {
        dockButton = "TeleHanging";
    }
...
<button class="btn {$gameData[dockButton] === 0
    ...
    : $gameData[dockButton] === 1
    ? "btn-secondary"
    : "btn-success"} {$gameData["Park"] === 1 ? "btn-disabled" : "" || $gameData["TeleBalanced"] === 2 ? "btn-disabled" : "" }" on:click={handleClick}>Hanging?</button>
