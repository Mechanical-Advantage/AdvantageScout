...
<g>
    ...
    <line
        ...
        x2={(width / defaultWidth) * 110}
        y1={(height / defaultHeight) * 10}
        x1={(width / defaultWidth) * 25}
        stroke={strokeColor}
        fill="none"
    />
    <!-- start zone -->
    <line
        stroke-width={strokeWidth}
        id="svg_2"
        y2={(height / defaultHeight) * 210}
        x2={(width / defaultWidth) * 110}
        y1={(height / defaultHeight) * 10}
        x1={(width / defaultWidth) * 110}
        stroke={strokeColor}
        fill="none"
    />
    <!-- subwoofer -->
    <line
        ...
        id="svg_3"
        y2={(height / defaultHeight) * 210}
        x2={(width / defaultWidth) * 25}
        y1={(height / defaultHeight) * 210}
        x1={(width / defaultWidth) * 110}
        stroke={strokeColor}
        fill="none"
    />
    ...
    <line
        id="svg_5"
        y2={(height / defaultHeight) * 25}
        x2={(width / defaultWidth) * 10}
        y1={(height / defaultHeight) * 195}
    ...
    <line
        id="svg_7"
        y2={(height / defaultHeight) * 65}
        x2={(width / defaultWidth) * 25}
        y1={(height / defaultHeight) * 65}
        x1={(width / defaultWidth) * 10}
        stroke-width={strokeWidth}
        stroke={strokeColor}
        fill="none"
