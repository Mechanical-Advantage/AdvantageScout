...
for match in match_data:
    #print(match)
    sql_text = 'INSERT INTO "SupesTable" ("Event", "Team", "Match", "DeviceName", "Version", "InterfaceType", "Time", "UploadTime", "ScoutName", "AllianceColor", "ReversedAlliance", "StartPosition", "StartGamePiece", "StartConfig", "Comment", "AutoComment", "TeleComment", "EndgameComment", "DisabledComment", "BotState", "AutoBotState", "TeleBotState", "EndgameBotState", "AutoSynergyRating", "TeleSynergyRating", "DefenseRating", "TeamRating1", "TeamRating2", "TeamRating3", "PlayingDefenseDuration", "UnderDefenseDuration", "DNP", "DNPComment", "DriverTeam", "DriverSkill", "DriverSpeed", "DefenseOnly") VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'    
